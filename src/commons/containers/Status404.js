...
const Status404 = () => {
  return (
    <section className="sds-page-centered">
      <img className="sds-margin-vertical" width="272px" height="179px" src={`${process.env.PUBLIC_URL}/assets/imgs/404.svg`} alt="Imagem de uma tempestade dentro de um computador" />
